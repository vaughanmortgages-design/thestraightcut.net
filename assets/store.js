...
(function addCollectiblesSpotlight(){
  ...
  section.innerHTML=`<div class="section-heading"><span class="section-kicker">Collectibles & Kids Picks</span><h2>Collectibles worth hunting.</h2><p>Pokémon, LEGO and live vintage Disney searches on eBay.</p></div><div class="editorial-grid"><a class="editorial-card" href="/pokemon-deals.html"><span class="editorial-card-copy"><span class="card-kicker">Pokémon Deals</span><h3>Cards, ETBs & collector finds</h3><p>Elite Trainer Boxes, booster bundles, Funko and more.</p><span class="card-action">Shop Pokémon →</span></span></a><a class="editorial-card" href="/lego-deals.html"><span class="editorial-card-copy"><span class="card-kicker">LEGO Deals</span><h3>Star Wars, Technic & Speed Champions</h3><p>Current LEGO listings pulled into one quick browse.</p><span class="card-action">Shop LEGO →</span></span></a><a class="editorial-card" href="/vintage-disney.html"><span class="editorial-card-copy"><span class="card-kicker">Vintage Disney Finds</span><h3>Park pieces, pins & rare collectibles</h3><p>Live tracked eBay searches with practical collector checks.</p><span class="card-action">Enter the vintage shop →</span></span></a></div>`;
